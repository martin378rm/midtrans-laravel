            ...
            <div class="col-md-12">
                <form class="form-kategori" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_subcategory" placeholder="Nama Kategori">
                    </div>
    ...
    <script>
        $(function () {
            ...
            $.ajax({
                ...
                success : function ({data}) {
                    ...
                    data.map((value,index) => {
                        ...
                        <tr>
                            <td>${index+1}</td>
                            <td>${value.nama_subcategory}</td>
                            <td>${value.categories.nama_kategory}</td>
            ...
            $(document).on('click', '.modal-ubah', function () {
               ...
               $.get('/api/sub-categories/' + id, function({data}){
                console.log(data);
                ...
                $('.form-kategori').submit(function (e) {
                    ...
                    $.ajax({
                        url : `/api/sub-categories/${id}?_method=PUT`,
                        type : 'POST',
                        data :formdata,
                        cache : false,
                        contentType: false,
