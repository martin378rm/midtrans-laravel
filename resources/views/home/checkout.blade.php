    ...
    <div class="container relative">
        <div class="row">
            ...
            <div class="ecommerce col-xs-12">
                ...
                <form name="checkout" method="POST" action="/payment" class="checkout ecommerce-checkout row">
                    @csrf
                    ...
                    <div class="col-md-8" id="customer_details">
                        <div>
                            ...
                            <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                ...
                                <select name="kabupaten" id="kabupaten" class="country_to_state kabupaten"
                                    rel="calc_shipping_state">
                            ...
                            <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                ...
                                <input type="text" class="input-text" placeholder value name="nama"
                                    id="billing_first_name">
                            </p>
                            <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                id="billing_first_name_field">
                            ...
                            <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                id="billing_first_name_field">
                                <label for="billing_first_name">Total Pembayaran
                                    <abbr class="required" title="required">*</abbr>
                                </label>
                            ...
                            <table class="table shop_table ecommerce-checkout-review-order-table">
                                <tbody>
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            <strong><span class="amount">{{rupiah($orders->grand_total)}}</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
